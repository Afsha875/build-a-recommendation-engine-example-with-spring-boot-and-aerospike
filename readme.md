...
2. Retrieve Jane's customer profile
...
Aerospike has the ability to backup and restore the data in an entire cluster. The test data for this application is stored as an Aerospike backup file. 
...
## Maintainer
Afsha Fathima is a Backend Developer with over 4 years of experience building robust backend applications, REST APIs, and service integrations. With a strong focus on application reliability and performance, she maintains this project to demonstrate efficient database integration and business logic implementation in high-concurrency environments.
